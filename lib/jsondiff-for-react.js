...
var _jsondiffpatchUmd = require('jsondiffpatch/dist/jsondiffpatch.umd.js');

var Jsondiffpatch = _interopRequireWildcard(_jsondiffpatchUmd);
...
var JsonDiffReact = function (_Component) {
  ...
  _createClass(JsonDiffReact, [{
    ...
    value: function render() {
      ...
      var delta = Jsondiffpatch.create({ objectHash: objectHash }).diff(left, right);
